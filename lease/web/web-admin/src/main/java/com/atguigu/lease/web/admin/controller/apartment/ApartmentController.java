...
public class ApartmentController {
    ...
    public Result<ApartmentDetailVo> getDetailById(@RequestParam Long id) {
        ApartmentDetailVo result = apartmentInfoService.getDetailsById(id);
        return Result.ok(result);
    }
    ...
    public Result updateReleaseStatusById(@RequestParam Long id, @RequestParam ReleaseStatus status) {
        LambdaUpdateWrapper<ApartmentInfo> queryWrapper = new LambdaUpdateWrapper<>();
        queryWrapper.eq(ApartmentInfo::getId, id);
        queryWrapper.set(ApartmentInfo::getIsRelease, status);
        apartmentInfoService.update(queryWrapper);
        return Result.ok();
    }
